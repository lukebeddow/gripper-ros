...
""".format(gripper_actuator_string)
...
""".format(panda_actuator_string, gripper_actuator_string)
...
if __name__ == "__main__":
  ...
  # add the compiler information to all
  add_chunk(gripper_tree, "@root", all_compiler)
  add_chunk(panda_tree, "@root", all_compiler)
  add_chunk(both_tree, "@root", all_compiler)

  # add the size information to each
  add_chunk(gripper_tree, "@root", gripper_size)
  add_chunk(panda_tree, "@root", panda_size)
  add_chunk(both_tree, "@root", panda_and_gripper_size)
