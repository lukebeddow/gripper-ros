...
class PolyClass
{
  /* wrap this code into a class to use for ros */

  // previously define statements
...
public:
  ...
  void RunPoly()
  {
    ...
    if (determinant(Weights,n)==0.) {
        ...
        cout << "Program stopped" << endl;
        throw std::runtime_error("one or more points have zero error");
    } 
